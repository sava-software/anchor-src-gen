...
record SolAmountTypeNode(NestedTypeNode number) implements TypeNode {

  public static SolAmountTypeNode parse(final JsonIterator ji) {
  ...
  static final class Parser implements FieldBufferPredicate {
    ...
    SolAmountTypeNode createTypeNode() {
      return new SolAmountTypeNode(number);
    }
